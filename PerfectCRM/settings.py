...
SECRET_KEY = 'u-7bm4%_mf^wg&$+^&*pt$w#1@o&i&tw_x***g+rs5zil$j3+p'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'),os.path.join(BASE_DIR,'kingadmin/templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_HOST_PASSWORD = 'euvtrglugggubagj'  # 密码
